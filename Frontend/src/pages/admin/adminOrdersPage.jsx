...
export default function AdminOrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const res = await api.get('/orders/1/10', {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  return (
    <div className='w-full h-full p-6 flex flex-col'>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm">Manage and oversee all orders</p>
        </div>
        ...
        <div className="flex-1 overflow-auto">
          {isLoading ? (
            ...
            <div className="overflow-x-auto rounded-2xl shadow-2xl">
             ...
             <div className='h-full gap-4 flex items-center'> {totalOrders} Orders.</div>
        ...
        <div className="flex justify-center mt-6 gap-2 pt-6 border-t border-gray-200">
          <button
            className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold transition-colors duration-200 shadow-md hover:shadow-lg"
